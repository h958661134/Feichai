...
public class Energy_Tree_WaterView  extends FrameLayout {
        ...
        private int mChildViewRes = R.layout.energy_tree_water_item;//子view的资源文件

        private LayoutInflater mInflater;
        public int mTotalConsumeWater;//总的已经点击的水滴
        ...
        My_Energy_Tree my_energy_tree;

        public Energy_Tree_WaterView(@NonNull Context context) {
            this(context, null);
        }

        public Energy_Tree_WaterView(@NonNull Context context, @Nullable AttributeSet attrs) {
            this(context, attrs, 0);
        }

        public Energy_Tree_WaterView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
         ...
         * @param waters
         */
        public void setWaters(final List<Energy_Tree_Water> waters) {
         ...
         * @param waters
         */
        private void setDatas(List<Energy_Tree_Water> waters) {
            reset();
     ...
     * 添加水滴view
     */
    private void addWaterView(List<Energy_Tree_Water> waters) {
        for (int i = 0; i < waters.size(); i++) {
            final Energy_Tree_Water water = waters.get(i);
        ...
        private void handViewClick(View view) {
            ...
            if (tag instanceof Energy_Tree_Water) {
                Energy_Tree_Water waterTag = (Energy_Tree_Water) tag;
                this.mTotalConsumeWater += waterTag.getNumber();
