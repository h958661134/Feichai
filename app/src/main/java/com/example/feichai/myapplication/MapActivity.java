...
public class MapActivity extends Activity implements LocationSource,AMapLocationListener {
    ...
    String user_name,nearname,manage_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //System.out.println("用户"+user_name+"进入Map");
    ...
    public void addCircle1(){
        ...
        circleOptions.center(new LatLng(34.8176700000,114.3083500000));
        circleOptions.radius(1000);
        circleOptions.strokeWidth(8);
        circleOptions.strokeColor(Color.argb(50,0,0,0));
    ...
    public void skip_to_activity(View view){
        ...
        switch (view.getId()){
            ...
            case R.id.main:
                ...
                break;
            case R.id.classify:
                Intent intent2 = new Intent(MapActivity.this,ClassifyActivity.class);
                ...
                break;
            case R.id.trade:
                Intent intent3 = new Intent(MapActivity.this,Trade_Activity.class);
            ...
            case R.id.personal_center:
                Intent intent4 = new Intent(MapActivity.this,Personal_Center.class);
