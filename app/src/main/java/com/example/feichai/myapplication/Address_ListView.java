...
public class Address_ListView extends ListView {
    ...
    public Address_ListView(Context context) {
        this(context, null);
    }

    public Address_ListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public Address_ListView(Context context, AttributeSet attrs, int defStyle) {
