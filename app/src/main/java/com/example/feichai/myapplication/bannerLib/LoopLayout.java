...
import com.example.feichai.myapplication.util.L;
import com.example.feichai.myapplication.util.Tools;
...
public class LoopLayout extends RelativeLayout {
     ...
     */
    public void setOnLoadImageViewListener(OnDefaultImageViewLoader onLoadImageViewListener) {
                    ...
                    if (positionOffset == 0f) {
                        ...
                        if (bigIndex != -1) {
                            if (loopAdapterWrapper.getPrimaryItem(bigIndex) != null) {
                                imageView = (ImageView) loopAdapterWrapper.getPrimaryItem(bigIndex).findViewById(R.id.iv_loop_banner);
